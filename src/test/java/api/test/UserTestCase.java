...
public class UserTestCase 
{
	   ...
	   public void testPostUser()
	   {
		   ...
		   Response response=UserEndPoints.createUser(pojobj);
	   ...
	   public void testGetUser()
	   {
		   ...
		   Response response=UserEndPoints.getUser(this.pojobj.getUsername());
		   response.then().log().all();
		   Assert.assertEquals(response.getStatusCode(), 200);
	   ...
	   public void testUpdateUser()
	   {
		   ...
		   pojobj.setFirstName(faker.name().firstName());
       		...
       		Response response=UserEndPoints.updateUser(this.pojobj.getUsername(), pojobj);
       		response.then().log().body();
       		
       		Assert.assertEquals(response.getStatusCode(), 200);
       		
       		Response responseAfterUpdate=UserEndPoints.getUser(this.pojobj.getUsername());
	   ...
	   public void testDeleteUser()
	   {
		   ...
		   Response response=UserEndPoints.deleteUser(this.pojobj.getUsername());
		    response.then().log().all();
